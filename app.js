...
const languageDefinitions = {
  zh: {
    ...
    mapFitStatus: "已切到经典棋盘：显示当前位置附近约 100 个地点，保留大富翁棋盘感。",
  ...
  en: {
    ...
    mapFitStatus: "Classic board is on: about 100 nearby locations are shown with a stronger board-game feel.",
  ...
  es: {
    ...
    mapFitStatus: "Tablero clásico activado: muestra cerca de 100 lugares con más sensación de juego de mesa.",
